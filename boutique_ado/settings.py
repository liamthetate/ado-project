...
SECRET_KEY = 'django-insecure-seprlu-6kvhy$v38jz65i(!r^vh3#@b4n#lhufielmbqsvoj$c'
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [                           #accesible across the entire website because its listed here
